...
(
	...
	ScoreBoardID VARCHAR(8) NOT NULL REFERENCES SCOREBOARD(ScoreBoardID),
	SubjectID VARCHAR(6) NOT NULL REFERENCES SUBJECT(SubjectID),
	Quiz FLOAT,
	_15MinuteS01 FLOAT,
	_15MinuteS02 FLOAT,
...
(
	...
	Grade VARCHAR(2),
	ConductSE01 VARCHAR(10),
	ConductSE02 VARCHAR(10),
	YearConduct VARCHAR(10),
...
(
	PunishmentID VARCHAR(6) PRIMARY KEY,
	Content NVARCHAR(1000) NOT NULL,
	Fault NVARCHAR(1000) NOT NULL,
	Semester INT DEFAULT 1,
	Year INT DEFAULT YEAR(GETDATE())
);
GO

CREATE TABLE PUNISHMENTLIST
(
	PunishmentListID VARCHAR(6) PRIMARY KEY,
	Punishment01 VARCHAR(6) REFERENCES PUNISHMENT(PunishmentID),
	Punishment02 VARCHAR(6) REFERENCES PUNISHMENT(PunishmentID),
	Punishment03 VARCHAR(6) REFERENCES PUNISHMENT(PunishmentID),
	Punishment04 VARCHAR(6) REFERENCES PUNISHMENT(PunishmentID),
	Punishment05 VARCHAR(6) REFERENCES PUNISHMENT(PunishmentID),
...
(
	...
	PunishmentListID VARCHAR(6) REFERENCES PUNISHMENTLIST(PunishmentListID)
...
(
	RewardListID VARCHAR(6) NOT NULL PRIMARY KEY,
	StudentID VARCHAR(8) NOT NULL REFERENCES STUDENT(StudentID),
	Year INT NOT NULL DEFAULT YEAR(GETDATE()),
	Semester INT  NOT NULL DEFAULT 1,
	Classtification VARCHAR(10) NOT NULL,
);
GO
